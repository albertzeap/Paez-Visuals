...
<div className="column">
                        ...
                        <p className="has-text-centered is-italic is-size-7">***Please note that all prices and services are subject to change based on demand</p>
                        <p className="has-text-centered is-italic is-size-7">The above services are typical serivces that I provide but does not restrict me from pursuing other creative projects</p>
                        <p className="has-text-centered is-italic is-size-7">As far as prices, they are my desired rates but are open to negotion based on the client***</p>
                        </div>
                    </div>
                </section>
            </Transition>
